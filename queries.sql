...
-- 
SELECT
    cpa.booking_agent_email,
    SUM(cpa.commission) AS total_commission
FROM
    commission_per_agent cpa
...
-- 
INSERT INTO
    ticket (customer_email, airline_name, flight_id)
VALUES
    ('{}', '{}', '{}');
...
-- 
INSERT INTO
    commission_per_agent (booking_agent_email, ticket_id, commission)
VALUES
    ('{}', '{}', '{}');
...
-- 
SELECT
    SUM(cpa.commission) / COUNT(DISTINCT p.ticket_id) as avg_commission_per_ticket
FROM
    purchases p
    JOIN ticket t on t.id = p.ticket_id
...
-- 
SELECT
    SUM(F.price) as money_spent_per_month,
    YEAR (P.purchase_date) AS year,
    MONTH (P.purchase_date) AS month
FROM
    purchases as P
